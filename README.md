...
- Frontend: React, Webpack, Redux Toolkit, Tailwind CSS
...
- In development, frontend API calls use the Webpack Dev Server proxy prefix `/api`, so refreshing React routes like `/products`, `/cart`, or `/admin/products` should keep showing the website instead of backend JSON.
...
The frontend uses the Webpack Dev Server proxy in development. You usually do not need to edit frontend env files.
